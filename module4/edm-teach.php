...
<body>
    ...
    <p>
    	<div id="step1" hidden>
            ...
            <select>
            	<?php
						...
						{
					?>
                    	<option value="<?=$row['layout_path']?>"><?=$row['layout_name']?></option>
                    <?php		
						}
					?>
            </select>
        ...
        <div id="step2" hidden>
        		步驟二、填寫資訊
                <p>
        		電子報名稱<input placeholder="必填" type="text" name="edm_name">
                <p>
                標題<input placeholder="必填" type="text" name="title">
                <p>
                內容
