...
<body>
    ...
    <p>
        ...
        <div id="step2" hidden>
        		步驟二、填寫資訊
                <p>
        		電子報名稱<input placeholder="必填" type="text" name="edm_name" value="<?=$edm['edm_name']?>">
                <p>
                標題<input placeholder="必填" type="text" name="title" value="<?=$edm['title']?>">
                <p>
                內容
